...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Location location1 = new Location("Sokcho", "01", 38.2072, 128.5911,
        ...
        Location location2 = new Location("Chuncheon", "02", 37.8825, 127.7295,
        ...
        Location location3 = new Location("Yangyang", "03", 38.1304, 128.6615,
        ...
        Location location4 = new Location("Gangneung", "04",37.7572, 128.8760,
        ...
        Location location5 = new Location("Taebaek", "05",37.1105, 128.9861,
        ...
        Location location6 = new Location("Yeongwol", "06",37.6778, 128.5573,
        ...
        Location location7 = new Location("Donghae", "07",37.5202, 129.1008,
