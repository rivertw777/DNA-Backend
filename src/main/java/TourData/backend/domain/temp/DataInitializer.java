...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Location location1 = Location.createLocation("Sokcho",  LocationCode.SOCKCHO, 38.2072, 128.5911,
        ...
        Location location2 = Location.createLocation("Chuncheon",  LocationCode.CHUNCHEON, 37.8825, 127.7295,
        ...
        Location location3 = Location.createLocation("Yangyang", LocationCode.YANGYANG, 38.1304, 128.6615,
        ...
        Location location4 = Location.createLocation("Gangneung", LocationCode.GANGNEUNG, 37.7572, 128.8760,
        ...
        Location location5 = Location.createLocation("Taebaek", LocationCode.TAEBAEK, 37.1105, 128.9861,
        ...
        Location location6 = Location.createLocation("Yeongwol", LocationCode.YEONGWOL, 37.6778, 128.5573,
        ...
        Location location7 = Location.createLocation("Donghae", LocationCode.DONGHAE, 37.5202, 129.1008,
        ...
        Facility facility1 = Facility.createFacility("맥도날드", FacilityType.RESTAURANT, LocationCode.SOCKCHO,"강원도 속초시",37.3972, 126.9296);
        facilityRepository.save(facility1);

        Facility facility2 = Facility.createFacility("이디야", FacilityType.CAFE, LocationCode.CHUNCHEON, "강원도 속초시",37.3944, 126.9306);
