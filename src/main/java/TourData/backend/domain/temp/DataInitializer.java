...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Location location1 = Location.createLocation(LocationName.SOCKCHO, 38.2072, 128.5911,
        ...
        Location location2 = Location.createLocation( LocationName.CHUNCHEON, 37.8825, 127.7295,
        ...
        Location location3 = Location.createLocation(LocationName.YANGYANG, 38.1304, 128.6615,
        ...
        Location location4 = Location.createLocation(LocationName.GANGNEUNG, 37.7572, 128.8760,
        ...
        Location location5 = Location.createLocation( LocationName.TAEBAEK, 37.1105, 128.9861,
        ...
        Location location6 = Location.createLocation( LocationName.YEONGWOL, 37.6778, 128.5573,
        ...
        Location location7 = Location.createLocation(LocationName.DONGHAE, 37.5202, 129.1008,
